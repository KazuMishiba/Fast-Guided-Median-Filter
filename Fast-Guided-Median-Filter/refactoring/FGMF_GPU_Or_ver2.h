...
namespace FGMF_GPU_Or_ver2
{
	...
	public:
		...
		{
			//f_device_(&Helper::DeviceArray<int>(f_img, sizeInfo_)), g_device_(&Helper::DeviceArray<int>(g_img, sizeInfo_)), , result_device_(&Helper::DeviceArray<int>(channelNum_f_, sizeInfo_))
			//check validation
			...
			//Helper::UtilityForCUDA::showDeviceshowDevice(g_device_->device[0], sizeInfo_, "test");
		}
...
//		int m_; // x^- = x - r - 1 = x + m_
		...
		//////////////////////////////////
		//2D
		static void filter2DGPU_G1(Helper::DeviceArray<int>*& f, Helper::DeviceArray<int>*& g, Helper::DeviceArray<int>*&  result, int radius, float eps2, int fRange, Helper::SizeInfo& sizeInfo);

		static void filter2DGPU_G3(Helper::DeviceArray<int>*& f, Helper::DeviceArray<int>*& g, Helper::DeviceArray<int>*& result, int radius, float eps2, int fRange, Helper::SizeInfo& sizeInfo);

#if 0
		//I1G3, I3G3 template GTYPE = int or Helper::DeviceArray<int>
		template<typename ITYPE>
		static void filter2DGPU(ITYPE*& I, Helper::DeviceArray<int>*& G, ITYPE*& result, int radius, float eps2, int fRange, Helper::SizeInfo& sizeInfo);

		//IXNGYN ITYPE = int or Helper::DeviceArray<int>
		template<typename ITYPE>
		static void filter2DGPU_MultiChannel(ITYPE*& I, Helper::DeviceArray<int>*& G, ITYPE*& result, int radius, float eps2, int fRange, Helper::SizeInfo& sizeInfo);

		//joint upsampling用
		template<typename ITYPE>
		static void upsamplingFilter2DGPU(ITYPE*& I, int*& G_high, int*& G_low, ITYPE*& result, int radius, float eps2, int fRange, Helper::SizeInfo& sizeInfo);
		template<typename ITYPE>
		static void upsamplingFilter2DGPU(ITYPE*& I, Helper::DeviceArray<int>*& G_high, Helper::DeviceArray<int>*& G_low, ITYPE*& result, int radius, float eps2, int fRange, Helper::SizeInfo& sizeInfo);
	...
	template<typename ITYPE>
	static void WMF::filter2DGPU(ITYPE*& I, Helper::DeviceArray<int>*& G, ITYPE*& result, int radius, float eps2, int fRange, Helper::SizeInfo& sizeInfo)
	{
		float4* cxdx;
		...
		//median計算
		FGMF_GPU_Or_ver2::cu_filter2DF1(sizeInfo, NULL, radius, fRange, result, I, G, cxdx);
	...
	static void WMF::filter2DGPU_MultiChannel(ITYPE*& I, Helper::DeviceArray<int>*& G, ITYPE*& result, int radius, float eps2, int fRange, Helper::SizeInfo& sizeInfo)
	{
		...
		//median計算
		FGMF_GPU_Or_ver2::cu_filter2DMultiChannel(sizeInfo, NULL, radius, fRange, result, I, G, cxdx);
	...
	template<typename ITYPE>
	static void WMF::upsamplingFilter2DGPU(ITYPE*& I, int*& G_high, int*& G_low, ITYPE*& result, int radius, float eps2, int fRange, Helper::SizeInfo& sizeInfo)
	{
		float2* cxdx;
		int2* sumG, * temp;
		UtilityForCUDA::allocateDeviceMemory(cxdx, sizeInfo);
		...
		//median計算
		FGMF_GPU_Or_ver2::cu_filter2DF1(sizeInfo, NULL, radius, fRange, result, I, G_high, cxdx);
	...
	//I1G3, I3G3 ITYPE = int or Helper::DeviceArray<int>
	template<typename ITYPE>
	static void WMF::upsamplingFilter2DGPU(ITYPE*& I, Helper::DeviceArray<int>*& G_high, Helper::DeviceArray<int>*& G_low, ITYPE*& result, int radius, float eps2, int fRange, Helper::SizeInfo& sizeInfo)
	{
		float4* cxdx;
		UtilityForCUDA::allocateDeviceMemory(cxdx, sizeInfo);
		Helper::DeviceArray<int>* sumG = new Helper::DeviceArray<int>(3, sizeInfo);
