...
namespace FGMF_GPU_Or_ver0
{
	...
	template<typename ITYPE>
	static void WMF::filter2DGPU(ITYPE*& I, int*& G, ITYPE*& result, int radius, float eps2, int Imax, SizeInfo& sizeInfo)
	{
		float2* cxdx;
		int2* sumG, * temp;
		...
		//median計算
		FGMF_GPU_Or_ver0::cu_filter2D(sizeInfo, NULL, radius, Imax, result, I, G, cxdx);
		//メモリ開放
		cudaFree(cxdx);
		cudaFree(sumG);
		cudaFree(temp);
	...
	static void WMF::filter2DGPU(ITYPE*& I, int*& G, ITYPE*& result, int radius, float eps2, int Imax, SizeInfo& sizeInfo)
	{
		DeviceArray<float>* cxdx = new DeviceArray<float>(2, sizeInfo);
		int2* sumG, * temp;
		UtilityForCUDA::allocateDeviceMemory(sumG, sizeInfo);
		UtilityForCUDA::allocateDeviceMemory(temp, sizeInfo);
		int pixelNumInWindow = (radius * 2 + 1) * (radius * 2 + 1);
	...
	*/
	...
	template<typename ITYPE>
	static void WMF::filter2DGPU(ITYPE*& I, DeviceArray<int>*& G, ITYPE*& result, int radius, float eps2, int Imax, SizeInfo& sizeInfo)
	{
		float4* cxdx;
		UtilityForCUDA::allocateDeviceMemory(cxdx, sizeInfo);
	...
	//IXNGYN ITYPE = int or DeviceArray<int>
	template<typename ITYPE>
	static void WMF::filter2DGPU_MultiChannel(ITYPE*& I, DeviceArray<int>*& G, ITYPE*& result, int radius, float eps2, int Imax, SizeInfo& sizeInfo)
	{
		...
		//median計算
		FGMF_GPU_Or_ver0::cu_filter2DMultiChannel(sizeInfo, NULL, radius, Imax, result, I, G, cxdx);
	...
	//I1G1, I3G1 ITYPE = int or DeviceArray<int>
	template<typename ITYPE>
	static void WMF::upsamplingFilter2DGPU(ITYPE*& I, int*& G_high, int*& G_low, ITYPE*& result, int radius, float eps2, int Imax, SizeInfo& sizeInfo)
	{
		float2* cxdx;
		int2* sumG, * temp;
		UtilityForCUDA::allocateDeviceMemory(cxdx, sizeInfo);
		...
		//median計算
		FGMF_GPU_Or_ver0::cu_filter2D(sizeInfo, NULL, radius, Imax, result, I, G_high, cxdx);
	...
	//I1G3, I3G3 ITYPE = int or DeviceArray<int>
	template<typename ITYPE>
	static void WMF::upsamplingFilter2DGPU(ITYPE*& I, DeviceArray<int>*& G_high, DeviceArray<int>*& G_low, ITYPE*& result, int radius, float eps2, int Imax, SizeInfo& sizeInfo)
	{
		float4* cxdx;
		UtilityForCUDA::allocateDeviceMemory(cxdx, sizeInfo);
		DeviceArray<int>* sumG = new DeviceArray<int>(3, sizeInfo);
	...
	//I1G1, I3G1 ITYPE = int or DeviceArray<int>
	template<typename ITYPE>
	void WMF::filter3DGPU(std::vector<ITYPE*>& I, std::vector<int*>& G, std::vector<ITYPE*>& result, int radius_spacial, int radius_temporal, float eps2, int Imax, SizeInfo& sizeInfo)
	{
	...
	//I1G3, I3G3 ITYPE = int or DeviceArray<int>
	template<typename ITYPE>
	void WMF::filter3DGPU(std::vector<ITYPE*>& I, std::vector<DeviceArray<int>*>& G, std::vector<ITYPE*>& result, int radius_spacial, int radius_temporal, float eps2, int Imax, SizeInfo& sizeInfo)
	{
		/*
		* //ガイドに平滑化かける
		...
		for (int i = 0; i < I.size(); i++)
		{
			...
			WMF::filter2DGPU(G[i], G[i], tt, radius_spacial, eps2, Imax, sizeInfo);
	...
	//I1G1, I3G1 ITYPE = int or DeviceArray<int>
	template<typename ITYPE>
	void WMF::filter4DGPU(std::vector<ITYPE*>& I, std::vector<int*>& G, std::vector<ITYPE*>& result, int radius_spacial, int radius_temporal, float eps2, int Imax, SizeInfo& sizeInfo, int viewColumnNum)
	{
		//3Dの枠組みを拡張して実装する
		/*
	...
	//I1G3, I3G3 ITYPE = int or DeviceArray<int>
	template<typename ITYPE>
	void WMF::filter4DGPU(std::vector<ITYPE*>& I, std::vector<DeviceArray<int>*>& G, std::vector<ITYPE*>& result, int radius_spacial, int radius_temporal, float eps2, int Imax, SizeInfo& sizeInfo, int viewColumnNum)
	{
		//3Dの枠組みを拡張して実装する
		/*
		データを視点番号順(スキャンライン)で1列に並べたベクトル（＝3Dと同じデータ形式)とする。
	...
	//CPU-O(r) 入力1チャンネル
	template<typename GSum, typename FGSumUpToIndex, typename FG, typename GTYPE, typename CTYPE>
	cv::Mat WMF::filter2D_CPU_Or_AblationStudy(cv::Mat& I, cv::Mat& G, int threadNum, int radius, float eps2, int Imax)
	{
...
#pragma omp parallel for
	...
	//CPU-O(r) median tracking 無し
	template<typename GSum, typename FGSumUpToIndex, typename FG, typename GTYPE, typename CTYPE>
	cv::Mat WMF::filter2D_CPU_Or_woMedianTracking_AblationStudy(cv::Mat& I, cv::Mat& G, int threadNum, int radius, float eps2, int Imax)
	{
		return c::Mat();
	}
