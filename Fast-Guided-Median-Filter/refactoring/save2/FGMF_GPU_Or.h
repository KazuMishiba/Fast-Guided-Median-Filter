...
namespace FGMF_GPU_Or
{
	...
	static void WMF::filter2DGPU(ITYPE*& I, int*& G, ITYPE*& result, int radius, float eps2, int Imax, SizeInfo& sizeInfo)
	{
		...
		//median計算
		FGMF_GPU_Or::cu_filter2D(sizeInfo, NULL, radius, Imax, result, I, G, cxdx);
		//メモリ開放
		cudaFree(cxdx);
		cudaFree(sumG);
		cudaFree(temp);
	...
	*/
	...
	static void WMF::filter2DGPU_MultiChannel(ITYPE*& I, DeviceArray<int>*& G, ITYPE*& result, int radius, float eps2, int Imax, SizeInfo& sizeInfo)
	{
		...
		//median計算
		FGMF_GPU_Or::cu_filter2DMultiChannel(sizeInfo, NULL, radius, Imax, result, I, G, cxdx);
	...
	static void WMF::upsamplingFilter2DGPU(ITYPE*& I, int*& G_high, int*& G_low, ITYPE*& result, int radius, float eps2, int Imax, SizeInfo& sizeInfo)
	{
		...
		//median計算
		FGMF_GPU_Or::cu_filter2D(sizeInfo, NULL, radius, Imax, result, I, G_high, cxdx);
